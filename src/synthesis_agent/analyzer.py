...
SYSTEM_PROMPT = (
    ...
    "Your task is to compare the narrative against market odds.\n\n"
    "Produce:\n"
    ...
    "- verdict: no edge / possible edge / strong research edge\n"
    "- concise explanation in plain English\n\n"
    "CRITICAL RULE: Be highly conservative. If evidence is mixed, relies on rumor, "
    "or does not clearly outweigh the efficient market hypothesis, you MUST output 'no edge'."
)
